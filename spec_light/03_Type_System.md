...
- Runtime: `vexstringslice(ptr, start, end)` in `vex-runtime/c/vex_string.c`
- Panic: Out-of-bounds access or invalid UTF-8 split causes runtime panic
- Test: `examples/teststringslicing.vx`
...
Implementation: `vex-compiler/src/codegenast/builtins/builtintypes/collections.rs`
...
- Test file: `examples/testuniontypes.vx`
...
| `isinttype<T>(value: T)` | `bool` | Check if value is integer type |
| `isfloattype<T>(value: T)` | `bool` | Check if value is floating-point type |
| `ispointertype<T>(value: T)` | `bool` | Check if value is pointer type |
...
Previous: 02LexicalStructure.md 
Next: 04Variablesand_Constants.md
