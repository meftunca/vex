...
impl<'ctx> CodeGen<'ctx> {
    ...
    pub fn compile_hello_world(&self) -> Result<(), String> {
        ...
        let hello_str = self
            .builder
            .build_global_string_ptr("Hello from Vex!\n", "hello_str")
    ...
    pub fn compile_fibonacci(&self) -> Result<(), String> {
        ...
        let cond = self
            .builder
            .build_int_compare(IntPredicate::SLE, n, i64_type.const_int(1, false), "cmp")
        ...
        let n_minus_1 = self
            .builder
            .build_int_sub(n, i64_type.const_int(1, false), "n_minus_1")
            .map_err(|e| format!("Failed to build sub: {:?}", e))?;

        let n_minus_2 = self
            .builder
            .build_int_sub(n, i64_type.const_int(2, false), "n_minus_2")
            .map_err(|e| format!("Failed to build sub: {:?}", e))?;

        let call1 = self
            .builder
            .build_call(fib_fn, &[n_minus_1.into()], "fib_call1")
            .map_err(|e| format!("Failed to build call: {:?}", e))?;
        let result1 = call1.try_as_basic_value().left().unwrap().into_int_value();

        let call2 = self
            .builder
            .build_call(fib_fn, &[n_minus_2.into()], "fib_call2")
            .map_err(|e| format!("Failed to build call: {:?}", e))?;
        let result2 = call2.try_as_basic_value().left().unwrap().into_int_value();

        let sum = self
            .builder
            .build_int_add(result1, result2, "sum")
        ...
        let fib_call = self
            .builder
            .build_call(fib_fn, &[ten.into()], "fib_result")
            .map_err(|e| format!("Failed to build call: {:?}", e))?;
        let fib_result = fib_call
            .try_as_basic_value()
            .left()
            .unwrap()
            .into_int_value();
        ...
        let format_str = self
            .builder
            .build_global_string_ptr("fibonacci(10) = %lld\n", "format_str")
            .map_err(|e| format!("Failed to create string: {:?}", e))?;
    ...
    pub fn compile_gcd(&self) -> Result<(), String> {
        ...
        let a_ptr = self
            .builder
            .build_alloca(i32_type, "a_ptr")
            .map_err(|e| format!("Failed to build alloca: {:?}", e))?;
        let b_ptr = self
            .builder
            .build_alloca(i32_type, "b_ptr")
            .map_err(|e| format!("Failed to build alloca: {:?}", e))?;
        ...
        self.builder
            .build_store(a_ptr, a_param)
            .map_err(|e| format!("Failed to build store: {:?}", e))?;
        self.builder
            .build_store(b_ptr, b_param)
            .map_err(|e| format!("Failed to build store: {:?}", e))?;
        ...
        let b_val = self
            .builder
            .build_load(i32_type, b_ptr, "b_val")
            .map_err(|e| format!("Failed to build load: {:?}", e))?
            .into_int_value();

        let cond = self
            .builder
            .build_int_compare(IntPredicate::NE, b_val, i32_type.const_int(0, false), "cmp")
            .map_err(|e| format!("Failed to build compare: {:?}", e))?;
        ...
        let a_val = self
            .builder
            .build_load(i32_type, a_ptr, "a_val")
            .map_err(|e| format!("Failed to build load: {:?}", e))?
            .into_int_value();
        let b_val = self
            .builder
        ...
        let remainder = self
            .builder
            .build_int_signed_rem(a_val, b_val, "remainder")
            .map_err(|e| format!("Failed to build rem: {:?}", e))?;

        self.builder
            .build_store(b_ptr, remainder)
            .map_err(|e| format!("Failed to build store: {:?}", e))?;
        self.builder
            .build_store(a_ptr, temp)
            .map_err(|e| format!("Failed to build store: {:?}", e))?;
        ...
        let final_a = self
            .builder
            .build_load(i32_type, a_ptr, "final_a")
            .map_err(|e| format!("Failed to build load: {:?}", e))?
            .into_int_value();

        self.builder
            .build_return(Some(&final_a))
            .map_err(|e| format!("Failed to build return: {:?}", e))?;
        ...
        let gcd_call = self
            .builder
            .build_call(gcd_fn, &[a.into(), b.into()], "gcd_result")
            .map_err(|e| format!("Failed to build call: {:?}", e))?;
        let gcd_result = gcd_call
            .try_as_basic_value()
            .left()
            .unwrap()
            .into_int_value();
        ...
        let format_str = self
            .builder
            .build_global_string_ptr("gcd(48, 18) = %d\n", "format_str")
            .map_err(|e| format!("Failed to create string: {:?}", e))?;
    ...
    pub fn compile_factorial(&self) -> Result<(), String> {
        ...
        let fact_call = self
            .builder
            .build_call(fact_fn, &[five.into()], "fact_result")
            .map_err(|e| format!("Failed to build call: {:?}", e))?;
        let fact_result = fact_call
            .try_as_basic_value()
            .left()
            .unwrap()
            .into_int_value();
        ...
        let format_str = self
            .builder
            .build_global_string_ptr("factorial(5) = %lld\n", "format_str")
            .map_err(|e| format!("Failed to create string: {:?}", e))?;
    ...
    pub fn compile_prime(&self) -> Result<(), String> {
        ...
        self.builder
            .build_unconditional_branch(check_le_1)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        let cond1 = self
            .builder
            .build_int_compare(IntPredicate::SLE, n, i32_type.const_int(1, false), "le_1")
            .map_err(|e| format!("Failed to build compare: {:?}", e))?;
        self.builder
            .build_conditional_branch(cond1, return_false, check_le_3)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        let cond2 = self
            .builder
            .build_int_compare(IntPredicate::SLE, n, i32_type.const_int(3, false), "le_3")
            .map_err(|e| format!("Failed to build compare: {:?}", e))?;
        self.builder
            .build_conditional_branch(cond2, return_true, check_even)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        let mod2 = self
            .builder
            .build_int_signed_rem(n, i32_type.const_int(2, false), "mod2")
            .map_err(|e| format!("Failed to build rem: {:?}", e))?;
        let is_even = self
            .builder
            .build_int_compare(
            ...
            .map_err(|e| format!("Failed to build compare: {:?}", e))?;
        self.builder
            .build_conditional_branch(is_even, return_false, loop_init)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        let i_ptr = self
            .builder
            .build_alloca(i32_type, "i_ptr")
            .map_err(|e| format!("Failed to build alloca: {:?}", e))?;
        self.builder
            .build_store(i_ptr, i32_type.const_int(3, false))
            .map_err(|e| format!("Failed to build store: {:?}", e))?;
        self.builder
            .build_unconditional_branch(loop_header)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        let i_val = self
            .builder
            .build_load(i32_type, i_ptr, "i_val")
            .map_err(|e| format!("Failed to build load: {:?}", e))?
            .into_int_value();
        let i_squared = self
            .builder
            .build_int_mul(i_val, i_val, "i_squared")
            .map_err(|e| format!("Failed to build mul: {:?}", e))?;
        let loop_cond = self
            .builder
            .build_int_compare(IntPredicate::SLE, i_squared, n, "loop_cond")
            .map_err(|e| format!("Failed to build compare: {:?}", e))?;
        self.builder
            .build_conditional_branch(loop_cond, loop_body, return_true)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        let i_val2 = self
            .builder
            .build_load(i32_type, i_ptr, "i_val2")
            .map_err(|e| format!("Failed to build load: {:?}", e))?
            .into_int_value();
        let remainder = self
            .builder
            .build_int_signed_rem(n, i_val2, "remainder")
            .map_err(|e| format!("Failed to build rem: {:?}", e))?;
        let is_divisible = self
            .builder
            .build_int_compare(
                IntPredicate::EQ,
                remainder,
            ...
            .map_err(|e| format!("Failed to build compare: {:?}", e))?;
        self.builder
            .build_conditional_branch(is_divisible, return_false, loop_continue)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        let i_val3 = self
            .builder
            .build_load(i32_type, i_ptr, "i_val3")
            .map_err(|e| format!("Failed to build load: {:?}", e))?
            .into_int_value();
        let i_next = self
            .builder
            .build_int_add(i_val3, i32_type.const_int(2, false), "i_next")
            .map_err(|e| format!("Failed to build add: {:?}", e))?;
        self.builder
        ...
        for (name, val) in tests {
            ...
            let call = self
                .builder
                .build_call(prime_fn, &[test_val.into()], "prime_result")
                .map_err(|e| format!("Failed to build call: {:?}", e))?;
            let result = call.try_as_basic_value().left().unwrap().into_int_value();
    ...
    pub fn compile_power(&self) -> Result<(), String> {
        ...
        self.builder
            .build_conditional_branch(is_zero, exp_zero, exp_one)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        self.builder
            .build_conditional_branch(is_one, recurse, recurse)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        self.builder
            .build_conditional_branch(is_one_check, return_base_block, check_even)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;

        self.builder.position_at_end(return_base_block);
        self.builder
            .build_return(Some(&base))
            .map_err(|e| format!("Failed to build return: {:?}", e))?;
        ...
        let exp_div_2 = self
            .builder
            .build_int_signed_div(exp, i32_type.const_int(2, false), "exp_div_2")
            .map_err(|e| format!("Failed to build div: {:?}", e))?;

        let half_call = self
            .builder
            .build_call(power_fn, &[base.into(), exp_div_2.into()], "half_call")
            .map_err(|e| format!("Failed to build call: {:?}", e))?;
        let half = half_call
            .try_as_basic_value()
            .left()
        ...
        let exp_mod_2 = self
            .builder
            .build_int_signed_rem(exp, i32_type.const_int(2, false), "exp_mod_2")
            .map_err(|e| format!("Failed to build rem: {:?}", e))?;
        ...
        self.builder
            .build_conditional_branch(is_even, even_case, odd_case)
            .map_err(|e| format!("Failed to build branch: {:?}", e))?;
        ...
        let result_even = self
            .builder
            .build_int_mul(half, half, "result_even")
            .map_err(|e| format!("Failed to build mul: {:?}", e))?;
        self.builder
            .build_return(Some(&result_even))
            .map_err(|e| format!("Failed to build return: {:?}", e))?;

        // Odd case: return base * half * half
        self.builder.position_at_end(odd_case);
        let half_squared = self
            .builder
            .build_int_mul(half, half, "half_squared")
            .map_err(|e| format!("Failed to build mul: {:?}", e))?;
        let result_odd = self
            .builder
            .build_int_mul(base, half_squared, "result_odd")
            .map_err(|e| format!("Failed to build mul: {:?}", e))?;
        self.builder
            .build_return(Some(&result_odd))
            .map_err(|e| format!("Failed to build return: {:?}", e))?;
        ...
        let power_call = self
            .builder
            .build_call(power_fn, &[base_val.into(), exp_val.into()], "power_result")
            .map_err(|e| format!("Failed to build call: {:?}", e))?;
        let power_result = power_call
            .try_as_basic_value()
            .left()
            .unwrap()
            .into_int_value();
        ...
        let format_str = self
            .builder
            .build_global_string_ptr("power(2, 10) = %d\n", "format_str")
            .map_err(|e| format!("Failed to create string: {:?}", e))?;
