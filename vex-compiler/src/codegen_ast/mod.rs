...
impl<'ctx> ASTCodeGen<'ctx> {
    ...
    fn get_or_declare_vex_strcat_new(&self) -> Result<FunctionValue<'ctx>, String> {
    ...
    fn get_or_declare_i32_to_string(&self) -> Result<FunctionValue<'ctx>, String> {
    ...
    fn get_or_declare_i64_to_string(&self) -> Result<FunctionValue<'ctx>, String> {
    ...
    fn get_or_declare_f32_to_string(&self) -> Result<FunctionValue<'ctx>, String> {
    ...
    fn get_or_declare_f64_to_string(&self) -> Result<FunctionValue<'ctx>, String> {
