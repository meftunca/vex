...
// ===== Compiler hints / static asserts =====
#if defined(__STDC_VERSION__) && __STDC_VERSION__ >= 201112L
#define VEX_STATIC_ASSERT _Static_assert
#else
#define VEX_STATIC_ASSERT(cond, msg) typedef char static_assertion_##msg[(cond) ? 1 : -1]
#define _Static_assert(cond, msg) VEX_STATIC_ASSERT(cond, msg)
#endif
